...
Page({
    ...
    canvasClock: function () {
        ...
        function circle() {
            ...
            context.beginPath();
            context.arc(0, 0, width / 2 - 20, 0, 2 * Math.PI, true);
            context.closePath();
            // context.stroke();
            context.fill();
            //大圆内层圆
            ...
            context.beginPath();
            context.arc(0, 0, width / 2 - 38, 0, 2 * Math.PI, true);
            context.closePath();
            // context.stroke();
            context.fill();
            //渐变圆
            let grd = context.createCircularGradient(0, 0, width / 2 - 55);
